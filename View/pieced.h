...
#define VERTEX_FTR Vertex( QVector3D(-0.75f,  -0.75f,  0.50f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_FTL Vertex( QVector3D(0.0f,  -0.75f,  0.50f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_FBL Vertex( QVector3D(0.0f, 0.25f,  0.50f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_FBR Vertex( QVector3D( -0.75f, 0.25f,  0.50f), QVector3D( 0.0f, 0.0f, 1.0f ) )
...
//Creation d'un d coloré
static const Vertex ppd[] = {
    // Face 1 (Face)
