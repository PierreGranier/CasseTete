...
#define VERTEX_FTR1 Vertex( QVector3D( 0.75f,  0.75f,  0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_FTL1 Vertex( QVector3D(0.0f,  0.75f,  0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_FBL1 Vertex( QVector3D(0.0f, -0.25f,  0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
...
#define VERTEX_BTR1 Vertex( QVector3D( 0.75f,  0.75f, -0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_BTL1 Vertex( QVector3D(0.0f,  0.75f, -0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_BBL1 Vertex( QVector3D(0.0f, -0.25f, -0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_BBR1 Vertex( QVector3D(0.75f, -0.25f, -0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )

//Creation d'un y coloré
static const Vertex ppy[] = {
    // Face 1 (Face)
