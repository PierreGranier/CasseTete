/*
 * En fait, une transformation en 3D est juste assez compliquée pour que nous puissions finir par le sur-penser,
 * et ne rien produire de ce qui est utilisable ou maintenable.Donc pour l'instant,je vais appeler "Optimisation prématurée",
 * et faire une classe Transform3D simple qui fait exactement ce dont nous avons besoin,et rien de plus.
*/
