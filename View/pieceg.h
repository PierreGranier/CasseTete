...
#define VERTEX_FTR Vertex( QVector3D(0.75f,  0.75f,  0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_FTL Vertex( QVector3D(0.0f,  0.75f,  0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_FBL Vertex( QVector3D(0.0f, -0.25f,  0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_FBR Vertex( QVector3D( 0.75f, -0.25f,  0.25f), QVector3D( 0.0f, 0.0f, 1.0f ) )
...
//Vertex arriere
#define VERTEX_BTR Vertex( QVector3D( 0.75f,  0.75f, -0.50f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_BTL Vertex( QVector3D(0.0f,  0.75f, -0.50f), QVector3D( 0.0f, 0.0f, 1.0f ))
#define VERTEX_BBL Vertex( QVector3D(0.0f, -0.25f, -0.50f), QVector3D( 0.0f, 0.0f, 1.0f ) )
#define VERTEX_BBR Vertex( QVector3D( 0.75f, -0.25f, -0.50f), QVector3D( 0.0f, 0.0f, 1.0f )  )
...
//Creation d'un y coloré
static const Vertex ppg[] = {
    // Face 1 (Face)
